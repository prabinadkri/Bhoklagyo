...
public class OrderEventSender {
    ...
    public void sendOrderToCustomer(Long customerId, OrderResponse payload) {
        ...
        try {
            ...
            System.err.println("Failed to persist notification for customer " + customerId + ": " + e.getMessage());
        }
    }
    ...
    public void sendOrderToRestaurant(Long restaurantId, OrderResponse payload) {
        ...
        try {
            ...
            System.err.println("Failed to persist notification for restaurant " + restaurantId + ": " + e.getMessage());
        }
    }
    ...
    public void sendOrderCreatedToRestaurant(Long restaurantId, OrderResponse payload) {
        String topic = "/topic/orders/restaurant/" + restaurantId;
        messagingTemplate.convertAndSend(topic, payload);
        System.out.println("📤 WebSocket: Sent order CREATED notification to restaurant topic: " + topic);
        ...
        try {
            ...
            System.err.println("Failed to persist created-notification for restaurant " + restaurantId + ": " + e.getMessage());
        }
    }
